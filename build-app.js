...
const EXTRA_CSS = `
  ...
  body.is-owner #booking,
  body.is-owner .rules { display: none; }
  body.is-owner .toolbar { justify-content: flex-end; }
  ...
  /* Refused has to read as settled, not as still-waiting - muted, not alarming. */
  .req-status.is-declined { color: var(--ink-2); border-color: var(--line); background: var(--tint); }
`;
